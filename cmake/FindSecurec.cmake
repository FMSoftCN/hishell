...
pkg_check_modules(SECUREC libsec_config)

set(VERSION_OK TRUE)

if (SECUREC_VERSION)
    if (SECUREC_FIND_VERSION_EXACT)
        if (NOT("${SECUREC_FIND_VERSION}" VERSION_EQUAL "${SECUREC_VERSION}"))
            set(VERSION_OK FALSE)
        endif ()
    else ()
        if ("${SECUREC_VERSION}" VERSION_LESS "${SECUREC_FIND_VERSION}")
            set(VERSION_OK FALSE)
        endif ()
    endif ()
endif ()

if (NOT SECUREC_INCLUDE_DIRS)
    set(SECUREC_INCLUDE_DIRS ${SECUREC_INCLUDEDIR})
endif ()

include(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(SECUREC DEFAULT_MSG SECUREC_INCLUDE_DIRS SECUREC_LIBRARIES VERSION_OK)
