...
pkg_check_modules(HIACEJS hiacejs)

set(VERSION_OK TRUE)

if (HIACEJS_VERSION)
    if (HIACEJS_FIND_VERSION_EXACT)
        if (NOT("${HIACEJS_FIND_VERSION}" VERSION_EQUAL "${HIACEJS_VERSION}"))
            set(VERSION_OK FALSE)
        endif ()
    else ()
        if ("${HIACEJS_VERSION}" VERSION_LESS "${HIACEJS_FIND_VERSION}")
            set(VERSION_OK FALSE)
        endif ()
    endif ()
endif ()

if (NOT HIACEJS_INCLUDE_DIRS)
    set(HIACEJS_INCLUDE_DIRS ${HIACEJS_INCLUDEDIR})
endif ()

include(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(HIACEJS DEFAULT_MSG HIACEJS_INCLUDE_DIRS HIACEJS_LIBRARIES VERSION_OK)
