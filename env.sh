...
export HYBRIDOS_OUTPUT_ROOT="/home/projects/hybridos/device-side/Output/HBD/Root/"
...
# LD_LIBRARY_PATH
export LD_LIBRARY_PATH=$HYBRIDOS_OUTPUT_ROOT/lib/:$HYBRIDOS_OUTPUT_ROOT/usr/lib/$LD_LIBRARY_PATH 
