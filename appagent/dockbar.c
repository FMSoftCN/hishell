...
static int type[MAX_TARGET_NUMBER] = {0};
...
static void create_animation(HWND hWnd)
{
    ...
    if (m_animation) 
    {
        ...
        if(m_direction == DIRECTION_HIDE)
        {
            ...
            motionType = OutCirc;
            duration = m_dockbar_hide_time * (g_rcScr.right - m_DockBar_Left_Length - m_DockBar_X) / (g_rcScr.right - m_DockBar_Left_Length - m_DockBar_Start_x);
        }
        else
        {
            end = m_DockBar_Start_x;
            motionType = OutCirc;
            duration = m_dockbar_show_time * (m_DockBar_X - m_DockBar_Start_x) / (g_rcScr.right -  m_DockBar_Left_Length- m_DockBar_Start_x);
        }
...
static void ace_run(const char* bundleName)
{
    ...
    if ((pid = vfork ()) > 0) {
        ...
        sprintf(buff, "%s/hijs", dirname(execPath));
        execl (buff, "hijs",  ace_app_path, bundleName, ace_font_path, NULL);
        perror ("execl");
        _exit (1);
    }
    else {
...
static LRESULT DockBarWinProc (HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (message)
    {
        ...
        case MSG_CREATE:
            ...
            GetValueFromEtcFile(config_path, "hijs", "app_path", ace_app_path, PATH_MAX);
            GetValueFromEtcFile(config_path, "hijs", "font_path", ace_font_path, PATH_MAX);
            ...
            if(GetValueFromEtcFile(config_path, "dock_icon0", "icon_file", picture_file, ETC_MAXLINE) == ETC_OK)
            {
                ...
                GetIntValueFromEtcFile(config_path, "dock_icon0", "type", &type[ID_DISPLAY_BUTTON]);
            }
            ...
            if(GetValueFromEtcFile(config_path, "dock_icon1", "icon_file", picture_file, ETC_MAXLINE) == ETC_OK)
            {
                ...
                GetIntValueFromEtcFile(config_path, "dock_icon1", "type", &type[ID_HOME_BUTTON]);
            }
            ...
            if(GetValueFromEtcFile(config_path, "dock_icon2", "icon_file", picture_file, ETC_MAXLINE) == ETC_OK)
            {
                ...
                GetIntValueFromEtcFile(config_path, "dock_icon2", "type", &type[ID_TOGGLE_BUTTON]);
            }
            ...
            if(GetValueFromEtcFile(config_path, "dock_icon3", "icon_file", picture_file, ETC_MAXLINE) == ETC_OK)
            {
                ...
                GetIntValueFromEtcFile(config_path, "dock_icon3", "type", &type[ID_SETTING_BUTTON]);
            }
            ...
            if(GetValueFromEtcFile(config_path, "dock_icon4", "icon_file", picture_file, ETC_MAXLINE) == ETC_OK)
            {
                ...
                GetIntValueFromEtcFile(config_path, "dock_icon4", "type", &type[ID_ABOUT_BUTTON]);
            }
            ...
            if(GetValueFromEtcFile(config_path, "dock_icon5", "icon_file", picture_file, ETC_MAXLINE) == ETC_OK)
            {
                ...
                GetIntValueFromEtcFile(config_path, "dock_icon5", "type", &type[ID_SHUTDOWN_BUTTON]);
            }
            ...
            GetIntValueFromEtcFile(config_path, "system", "dockbar_animation_show_time", &m_dockbar_show_time);
            GetIntValueFromEtcFile(config_path, "system", "dockbar_animation_hide_time", &m_dockbar_hide_time);
